...
if __name__ == "__main__":
    ...
    parser.add_argument("--decoding-strategy","-ds", type=str, required=False, default="nucleus", choices=["greedy", "random", "topk", "nucleus"], help="The decoding strategy to be used during inference.")
    parser.add_argument("--tau","-t", type=float, required=False, default=0.9, help="Temperature value to be used with Random Sampling.")
